...
export const METERS: Meter[] = [
  ...
  { id: "5-4", label: "5/4", top: 5, bottom: 4, family: "odd",
    note: "Five beats to the bar. Accents in groups of 5 land on every downbeat." },
  { id: "7-4", label: "7/4", top: 7, bottom: 4, family: "odd" },
  { id: "6-8", label: "6/8", top: 6, bottom: 8, grouping: [3, 3], family: "compound",
    note: "Two beats to the bar, each split in three." },
  ...
  { id: "7-8", label: "7/8", top: 7, bottom: 8, grouping: [2, 2, 3], family: "odd",
    note: "Counted 2+2+3: the same seven a Bulgarian ruchenitsa dances." },

  /* ── Balkan asymmetric meters ─────────────────────────────────────────────
     Bulgarian music's fame is its metre, not a scale of its own. These are the
     dance metres by name. (Gati means pulses PER BEAT, so a seven-beat bar is
     not "misra gati"; the wording here keeps the two apart.)
  ...
  { id: "7-8-ruchenitsa", label: "7/8 · Ruchenitsa", top: 7, bottom: 8, grouping: [2, 2, 3], family: "odd",
    note: "2+2+3, the best-known Bulgarian dance metre." },
  ...
  { id: "11-8-kopanitsa", label: "11/8 · Kopanitsa", top: 11, bottom: 8, grouping: [2, 2, 3, 2, 2], family: "odd",
    note: "2+2+3+2+2, with the long beat in the middle. Eleven is prime; the bar count shows how long a pattern takes to come home." },
];
