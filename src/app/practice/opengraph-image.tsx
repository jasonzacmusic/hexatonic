...
export const alt = "Hexatonic — Practice";
      ...
      <div style={{ width: "100%", height: "100%", display: "flex", background: "#0A0908",
        ...
        <div style={{ display: "flex", flexDirection: "column", width: 700 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", marginTop: 30, fontSize: 76,
            ...
            <span>Drill it until</span><span>it lands on the one.</span>
          </div>
          <div style={{ display: "flex", marginTop: 26, fontSize: 25, color: "#B9B0A6",
                        lineHeight: 1.35, width: 620 }}>
            Any key, any mode, groupings of three to nine — with the bar-count it resolves on.
          </div>
