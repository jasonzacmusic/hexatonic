...
export const alt = "Hexatonic — Improvise";
      ...
      <div style={{ width: "100%", height: "100%", display: "flex", background: "#0A0908",
        ...
        <div style={{ display: "flex", flexDirection: "column", width: 700 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", marginTop: 30, fontSize: 80,
            ...
            <span>Pick a loop.</span><span>Play.</span>
          </div>
          <div style={{ display: "flex", marginTop: 26, fontSize: 25, color: "#B9B0A6",
                        lineHeight: 1.35, width: 620 }}>
            A backing band that plays only your scale's chords. The notes to land on light up as the chords change.
          </div>
